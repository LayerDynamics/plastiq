...
| **R6.4b-iii** | **General non-coaxial mixed parts** (e.g. box-with-cylindrical-hole) via surface–surface-intersection / boundary-snap shared edges — the research-grade frontier no OSS tool solves robustly. Deferred; the faceted fallback keeps these valid meanwhile. | planned |
