"""Structured logging for the capture service.
...
duplicate handlers. INFO by default; override with CAPTURE_LOG_LEVEL (DEBUG/INFO/WARNING/…).
"""
...
def setup_logging(*, level_env_var: str = "CAPTURE_LOG_LEVEL") -> logging.Logger:
