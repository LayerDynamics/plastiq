"""Structured logging for the NeRF service.
...
duplicate handlers. INFO by default; override with NERF_LOG_LEVEL (DEBUG/INFO/WARNING/…).
"""
...
def setup_logging(*, level_env_var: str = "NERF_LOG_LEVEL") -> logging.Logger:
