"""Structured logging for the reconstruct service.
...
duplicate handlers. INFO by default; override with RECONSTRUCT_LOG_LEVEL (DEBUG/INFO/WARNING/…).
"""
...
def setup_logging(*, level_env_var: str = "RECONSTRUCT_LOG_LEVEL") -> logging.Logger:
