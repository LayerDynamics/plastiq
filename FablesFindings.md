...
**NOT run this session (so not claimed as passing):** the Playwright e2e suite, and nothing has been driven in a real browser. §13.6/§13.8's e2e gaps and W3's stale spec are untouched.
